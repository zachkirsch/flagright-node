...
export const LegalEntity: core.serialization.ObjectSchema<serializers.LegalEntity.Raw, FlagrightApi.LegalEntity> =
    core.serialization.object({
        companyGeneralDetails: core.serialization.lazyObject(
            async () => (await import("../../..")).CompanyGeneralDetails
        ),
